...
export const PRESETS: Record<ModeId, Preset[]> = {
  ...
  words: [
    ...
    { name: "One element", params: { source: "vocab", vocabulary: "FORM SHAPE SUBJECT FIGURE", regionMode: "mix", applyTo: "subject", subjectDetect: "precise", background: "fade", matteTighten: 0.6, matteFeather: 1, shadow: 0.4, autoColor: true, columns: 40, toneMode: "opacity", paper: "cream", dissolve: 0.1, highlight: "#e0603a" } },
    { name: "Element cutout", params: { source: "vocab", vocabulary: "FORM SHAPE SUBJECT FIGURE", regionMode: "mix", applyTo: "subject", subjectDetect: "precise", background: "remove", matteTighten: 0.62, matteFeather: 1, shadow: 0.5, autoColor: true, columns: 40, toneMode: "opacity", paper: "cream", dissolve: 0.08, highlight: "#e0603a" } },
