...
export const PRESETS: Record<ModeId, Preset[]> = {
  ...
  words: [
    { name: "Seascape", params: { source: "vocab", vocabulary: "CLOUDS BOAT OCEAN", regionMode: "bands", columns: 34, toneMode: "opacity", paper: "cream", dissolve: 0.3, highlight: "#3a6ea5" } },
    { name: "Workspace", params: { source: "vocab", regionMode: "mix", columns: 28, toneMode: "opacity", paper: "cream", dissolve: 0.6, highlight: "#e0603a" } },
    { name: "Ledger", params: { source: "numbers", regionMode: "mix", columns: 40, toneMode: "opacity", paper: "white", dissolve: 0.4 } },
    { name: "Terrain", params: { source: "vocab", vocabulary: "SKY RIDGE FOREST VALLEY RIVER", regionMode: "bands", columns: 40, toneMode: "opacity", paper: "cream", dissolve: 0.25, highlight: "#2f7d4f" } },
    { name: "Manifesto", params: { source: "vocab", regionMode: "mix", columns: 24, toneMode: "weight", paper: "dark", dissolve: 0.3, highlight: "#f0a868", invert: true } },
    { name: "Whisper", params: { source: "lorem", regionMode: "mix", columns: 34, toneMode: "opacity", paper: "transparent", dissolve: 0.7 }, opacity: 0.7, blend: "screen" },
  ],
  slitscan: [
