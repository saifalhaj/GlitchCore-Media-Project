...
export const PRESETS: Record<ModeId, Preset[]> = {
  ...
  words: [
    ...
    { name: "Split reveal", params: { source: "vocab", vocabulary: "CLOUDS BOAT OCEAN", regionMode: "bands", applyTo: "right", splitAt: 0.5, background: "keep", edgeFade: 0.12, columns: 34, toneMode: "opacity", paper: "cream", dissolve: 0.18, highlight: "#3a6ea5" } },
    { name: "One element", params: { source: "vocab", vocabulary: "FORM SHAPE SUBJECT FIGURE", regionMode: "mix", applyTo: "subject", subjectDetect: "precise", background: "fade", bgFade: 0.72, edgeFade: 0.1, matteTighten: 0.6, matteFeather: 1, shadow: 0.4, autoColor: true, columns: 40, toneMode: "opacity", paper: "cream", dissolve: 0.1, highlight: "#e0603a" } },
    { name: "Element cutout", params: { source: "vocab", vocabulary: "FORM SHAPE SUBJECT FIGURE", regionMode: "mix", applyTo: "subject", subjectDetect: "precise", background: "remove", edgeFade: 0.12, matteTighten: 0.62, matteFeather: 1, shadow: 0.5, autoColor: true, columns: 40, toneMode: "opacity", paper: "cream", dissolve: 0.08, highlight: "#e0603a" } },
    ...
    { name: "Manifesto", params: { source: "vocab", regionMode: "mix", applyTo: "whole", columns: 24, toneMode: "weight", paper: "dark", dissolve: 0.3, highlight: "#f0a868", invert: true } },
    { name: "Whisper", params: { source: "lorem", regionMode: "mix", applyTo: "whole", columns: 34, toneMode: "opacity", paper: "transparent", dissolve: 0.7 }, opacity: 0.7, blend: "screen" },
  ],
  slitscan: [
